...
print(nume[
      0:2])  # Va acoperi primele doua caractere din string, pentru ca la slicing capatul superior de interval nu se ia in considerare
...
"""
nume_as_list = ['M', 'i', 'c', 'h', 'a', 'e',
                'l']  # in cazul asta ar avem o lista cu 7 elemente, fiecare element reprezentant o litera
...
"""
print(nume_as_list)
literaRemove = nume_as_list.remove(
    'c')  # Remove poate sa scoata un caracter din lista pe baza codului ASCII (pe baza caracterului in sine)
literaPop = nume_as_list.pop(5)  # Pop poate sa scoata un caracter din lista pe baza indexului
print(
    literaRemove)  # va printa None pentru ca functia remove al carei rezultat a fost salvat in variabila literaRemove nu are optiune de return
...
nume_as_list[
    0] = 'a'  # nume_as_list[0] este identificarea elementului pe baza de index, "=" reprezinta operatorul de atribuire
